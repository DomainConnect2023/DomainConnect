            ...
            if (password == retypePass) {
                ...
                await axios.post(URLAccess.userFunction, jsonData,).then(response => {
                    if (response.data.status == "1") {
                        Snackbar.show({
                            text: i18n.t("RegisterPage.Register-Success"),
                            duration: Snackbar.LENGTH_SHORT,
                        });
                        navigation.navigate(LoginScreen as never);
                    } else if (response.data.status == "2") {
                        Snackbar.show({
                            text: i18n.t("RegisterPage.UserName-Duplicated"),
                            duration: Snackbar.LENGTH_SHORT,
                        });
                    } else {
                        Snackbar.show({
                            text: i18n.t("RegisterPage.Register-Failed"),
                            duration: Snackbar.LENGTH_SHORT,
                            // action: {
                            //   text: 'UNDO',
                            //   textColor: 'green',
                ...
                Snackbar.show({
                    text: i18n.t("RegisterPage.Wrong-Password"),
                    duration: Snackbar.LENGTH_SHORT,
                });
            }
        } else {
            Snackbar.show({
                text: i18n.t("RegisterPage.Empty"),
                duration: Snackbar.LENGTH_SHORT,
            });
        }
    };
        ...
        <MainContainer>
            {Platform.OS === "android" ? (
                <View style={[css.mainView, { marginTop: -20 }]}>
                    ...
                    <View style={css.HeaderView}>
                        <Text numberOfLines={2} style={css.PageName}>{i18n.t("RegisterPage.Title")}</Text>
                    </View>
                </View>) : (
            ...
            <KeyboardAvoidWrapper>
                <View style={css.container}>
                    ...
                    />
                    <Text style={{ color: "#404040", fontWeight: "bold", fontSize: 20 }}>{i18n.t("RegisterPage.Title")}</Text>

                    {/* Company Name Detail */}
                    <View style={css.row}>
                        <Text style={css.inputText}>{i18n.t("RegisterPage.Company-Name")}: <Text style={{ color: "red" }}>*</Text></Text>
                        {viewCompanyName == true && companyName == "" ? (
                            <TextInput
                                style={[css.input, { borderColor: "#FF0606" }]}
                                placeholder={i18n.t("RegisterPage.Company-Name")}
                                value={companyName}
                    ...
                    {(viewCompanyName == true && companyName == "") && (
                        <View style={[css.row, { marginBottom: 10, }]}>
                            ...
                            <Text style={{ color: "#FF0606", width: '60%', fontSize: 10 }}>{i18n.t("RegisterPage.Empty")}</Text>
                        </View>
                    )}
                    {/* End Company Name */}
                    ...
                    {/* Vehicle Detail */}
                    <View style={[css.row, { marginBottom: 10, }]}>
                        <Text style={css.inputText}>{i18n.t("RegisterPage.Vehicle")}: </Text>
                        <TextInput
                            style={css.input}
                            placeholder={i18n.t("RegisterPage.Vehicle")}
                            value={verhicleNo}
                    ...
                    {/* User Name Detail */}
                    <View style={css.row}>
                        <Text style={css.inputText}>{i18n.t("RegisterPage.UserName.UserName")}: <Text style={{ color: "red" }}>*</Text></Text>
                        {viewName == true && username == "" ? (
                            <TextInput
                                style={[css.input, { borderColor: "#FF0606" }]}
                                placeholder={i18n.t("RegisterPage.UserName.UserName")}
                                value={username}
                    ...
                    <View style={[css.row, { marginBottom: 10, }]}>
                        <Text style={css.inputText}>{i18n.t("RegisterPage.Password.Password")}: <Text style={{ color: "red" }}>*</Text></Text>
                        {(password == "" && viewPass == true) ? (
                            <TextInput
                                style={[css.input, { borderColor: "#FF0606" }]}
                                placeholder={i18n.t("RegisterPage.Password.Password")}
                                secureTextEntry
                                value={password}
                    ...
                    <View style={css.row}>
                        <Text style={css.inputText}>{i18n.t("RegisterPage.Password.Retype-Password")}: <Text style={{ color: "red" }}>*</Text></Text>
                        {(password != retypePass && viewRetypePass == true) ? (
                            <TextInput
                                style={[css.input, { borderColor: "#FF0606" }]}
                                placeholder={i18n.t("RegisterPage.Password.Retype-Password")}
                                secureTextEntry
                                value={retypePass}
                    ...
                    {(password == "" && viewPass == true) ? (
                        <View style={[css.row, { marginBottom: 10, marginTop: -10 }]}>
                            <Text style={css.inputText}></Text>
                            <Text style={{ color: "#FF0606", width: '60%', fontSize: 10 }}>{i18n.t("RegisterPage.Password.Password-Empty")}</Text>
                        </View>
                    ) : (password != retypePass && viewRetypePass == true) ? (
                        <View style={[css.row, { marginBottom: 10, }]}>
                            <Text style={css.inputText}></Text>
                            <Text style={{ color: "#FF0606", width: '60%', fontSize: 10 }}>{i18n.t("RegisterPage.Password.Password-No-Match")}</Text>
                        </View>
                    ) : (<></>)}
                    ...
                    {/* Email Detail */}
                    <View style={css.row}>
                        <Text style={css.inputText}>{i18n.t("RegisterPage.Email")}: <Text style={{ color: "red" }}>*</Text></Text>
                        {viewName == true && username == "" ? (
                            <TextInput
                                style={[css.input, { borderColor: "#FF0606" }]}
                                placeholder={i18n.t("RegisterPage.Email")}
                                value={email}
                    ...
                    {(viewEmail == true && email == "") && (
                        <View style={[css.row, { marginBottom: 10, }]}>
                            <Text style={css.inputText}></Text>
                            <Text style={[{ color: "#FF0606", width: '60%', fontSize: 10 }]}>{i18n.t("register.Can'tBeEmpty")}</Text>
                        </View>
                    )}
                    {/* End Email Detail */}
                    ...
                    {/* Mobile Detail */}
                    <View style={css.row}>
                        <Text style={css.inputText}>{i18n.t("RegisterPage.Mobile.Mobile-Number")}: </Text>
                    ...
                    {(viewMobile == false) ? (
                        <View style={[css.row, { marginBottom: 10, }]}>
                            <Text style={css.inputText}></Text>
                            <Text style={[{ color: "#FF0606", width: '60%', fontSize: 10 }]}>{i18n.t("register.NumberInvalid")}</Text>
                        </View>
                    ...
                    {/* BirthDate Detail */}
                    <View style={[css.row, { marginBottom: 10, }]}>
                        <Text style={css.inputText}>{i18n.t("register.BirthDate")}: </Text>
                    ...
                    >
                        ...
                        >
                            <TextInput
                                style={{ color: "#000", }}
                                placeholder={i18n.t("register.SelectBirthDate")}
                                value={birthDate}
                    ...
                    <Pressable style={css.button} onPress={() => { registerAPI() }}>
                        <Text style={css.text}>{i18n.t("register.Register")}</Text>
                    </Pressable>
                </View>
            </KeyboardAvoidWrapper>
        </MainContainer>
