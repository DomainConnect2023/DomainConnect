...
function CustomDrawerContent(props: any) {
  ...
  return (
    ...
    >
      ...
      <DrawerItem label={i18n.t('Bottom-Navigation.LogOut')} onPress={()=>{navigation.navigate(Login as never)}}/>
...
export function CustomDrawer() {
  ...
  return (
    ...
    >
      <Drawer.Screen name={i18n.t('Bottom-Navigation.Dashboard')} component={TestDashboardScreen} 
      options={{
        headerTitle: i18n.t('Bottom-Navigation.Dashboard'),
        headerRight: () => (
...
<Drawer.Screen name={i18n.t('Bottom-Navigation.Setting')} component={TestSettingScreen} 
      options={{
        headerTitle: i18n.t('Bottom-Navigation.Setting'),
        headerRight: () => (
          <View style={{flex:1,flexDirection: "row",
          justifyContent: 'center',
          alignItems: 'center',}}>
